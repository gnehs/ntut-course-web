...
const changelogEntries: ChangelogEntry[] = [
	{
		...
		changes: [
			{
				title: '新增以學號前三碼查詢課程標準，並依入學年度推薦適用系所。',
			},
			{
				title: '改善課程搜尋與瀏覽體驗。',
				details: [
					'進階搜尋會在網址保留頁碼、檢視模式、學期與學制，返回頁面時可接續瀏覽。',
					'補強查無課程、資料載入失敗與重試等狀態提示。',
					'課程標準圖例只顯示目前實際使用的課程類型。',
				],
			},
			{
				title: '在設定中新增「我的課程」完整備份與移轉功能。',
				details: [
					'可匯出所有學期與學制的課程、班級及微學程選擇。',
					'匯入前會先顯示摘要，並以合併方式保留現有選擇。',
					'支援貼上舊版單學期備份資料。',
				],
			},
			{
				title: '改善常用頁面的資訊呈現與操作。',
				details: [
					'首頁新增搜尋、我的課程與班級課表的常用功能入口。',
					'微學程支援依名稱或代碼搜尋，並補充課程數量、學期及載入狀態。',
					'重新整理行事曆、設定與課程資訊的版面及互動細節。',
				],
			},
			{
				title: '改善學期資料載入失敗時的提示與復原流程。',
			},
			{
				title: '新增依學制產生的 Sitemap，讓搜尋引擎更完整收錄班級與課程頁面。',
			},
		],
	},
	{
